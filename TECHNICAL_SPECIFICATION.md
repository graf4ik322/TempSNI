...
- Web APIs (LocalStorage, Fetch, File API, Drag & Drop)
...
- Получение данных через публичные API (Fetch API)
- Кэширование запросов в localStorage
- Обработка ошибок сети с try/catch
...
- [ ] Интеграция с внешними API (Fetch)
